...
const DataProjects = [
  ...
  //------GESTIONE EVENTI------
  {
    ...
    descrizioneBreve:
      "Applicazione web per la gestione e prenotazione di eventi. Gli utenti possono registrarsi, visualizzare gli eventi disponibili, prenotare posti e annullare prenotazioni. Gli organizzatori possono creare, modificare o eliminare eventi. Il progetto è sviluppato in JavaScript, con logica lato client e gestione dei ruoli utente.",
    descrizioneLunga:
      'Gestione Eventi è un’applicazione web sviluppata in autonomia, con l’obiettivo di simulare una piattaforma completa per la creazione, gestione e prenotazione di eventi. L’app consente: Registrazione e autenticazione degli utenti, con due ruoli distinti: "Utente Normale" e "Organizzatore di Eventi"; Gli organizzatori possono creare eventi specificando dettagli come titolo, descrizione, luogo, data e numero di posti disponibili, e successivamente modificarli o cancellarli; Gli utenti normali possono prenotare posti per gli eventi disponibili e visualizzare o annullare le prenotazioni effettuate; Il sistema gestisce validazioni, messaggi di errore e feedback dinamici; L’interfaccia è completamente responsive e realizzata con HTML, CSS e JavaScript vanilla, senza framework. Il codice è versionato tramite Git e organizzato secondo buone pratiche di sviluppo frontend.',
  },
  //------GESTIONE VIAGGI-----
  {
    id: "GestioneViaggi",
